...
parser.add_argument('--config', type=str, default='/home/guest1/aum/DANCE/configs/officehome-train-config_CDA.yaml', help='/path/to/config/file')
...
parser.add_argument('--exp_name', type=str, default='officehome', help='/path/to/config/file')
...
try:
    ...
    save_config = yaml.load(open(config_file), Loader=Loader)
except:
